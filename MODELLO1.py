...
gianluca = Model()
gianluca.fit(mio_file.get_data())

class IncrementModel(Model):

    def fit(self, data):
        raise NotImplementError('Questo modello non prevede un fit')

    def prediction(self, prev_months):
        #Qui ci va il codice per far funzionare la predizione
        pass  
